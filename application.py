...
def view_review():
    ...
    reviews_per_page = 6
    total_pages = (len(reviews) + reviews_per_page - 1) // reviews_per_page  # 페이지 수 계산
    return render_template('review_overview.html', reviews=reviews, totalPages=total_pages, currentPage = 1, itemsPerPage = 6)
